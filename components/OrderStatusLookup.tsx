    ...
    <div className="narrow">
      <form className="form-card" onSubmit={submit}>
        <div className="form-grid">
          <div className="form-group">
            ...
            <input className="form-input" id="order-number" name="invoiceNumber" placeholder="HG-12345678" required />
          </div>
          <div className="form-group">
            <label htmlFor="order-email">Email used at checkout</label>
            <input className="form-input" id="order-email" name="email" type="email" autoComplete="email" required />
          </div>
        </div>
      ...
      {order && (
        <div className="admin-card" style={{ marginTop: 24 }}>
          ...
          <p className="muted">Placed {new Date(order.createdAt).toLocaleDateString('en-US', { dateStyle: 'long' })}</p>
