      ...
      <section className="content">
        <div className="container split">
          ...
          <div>
            ...
            <p>Our care library focuses on the practical questions that make the biggest difference — which plants belong together, how to arrange them, what soil and container to use, and how to keep a finished planter healthy once it gets home.</p>
            ...
            <div className="actions">
              {CLASSES_PUBLICLY_VISIBLE ? (
                <Link className="btn" href="/classes">Join us for a class</Link>
              ) : (
                <Link className="btn" href="/care">Browse plant care</Link>
              )}
              <Link className="btn outline" href="/contact">Ask us a question</Link>
            </div>
          </div>
        </div>
      </section>
      <section className="section alt">
        <div className="container">
          ...
          <div className="featuregrid">
            ...
            <div className="feature"><Users size={22} /><b>Better together</b><span>Growing is more fun shared, and plant questions are always welcome.</span></div>
