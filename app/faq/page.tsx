...
const questions = [
  ...
  ['Do you offer local pickup?', 'Local pickup is arranged directly with us rather than selected at checkout. Use the contact form to ask whether a piece can be picked up. Exact details are shared with confirmed customers rather than posted publicly.'],
