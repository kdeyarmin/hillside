...
const questions = [
  ...
  ['Do you offer local pickup?', 'Contact us first to arrange a time. After we confirm, choose local pickup at checkout. Some pieces are pickup only. A pickup is still not ready to collect until we email you — exact instructions are sent privately rather than posted here.'],
  ...
  ['How do I check my order?', 'Use the order-status page with the HG order number and the exact email used at checkout. Shipped orders show the carrier and tracking number there. Pickup orders show when the order is ready and point you to the email with the pickup window.'],
