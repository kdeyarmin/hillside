    ...
    <section className="classroom-page">
      <div className="container">
        <div className="classroom-event-summary">
          ...
          <h2>{event.title}</h2>
          <div>
            <span><CalendarDays size={16} /> {event.startsAt.toLocaleString('en-US', { dateStyle: 'full', timeStyle: 'short', timeZoneName: 'short' })}</span>
        ...
        {now < opensAt ? (
          <div className="classroom-access-card">
            ...
            <p>
              ...
              <strong>{opensAt.toLocaleString('en-US', { dateStyle: 'full', timeStyle: 'short', timeZoneName: 'short' })}</strong>.
            </p>
