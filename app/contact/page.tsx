...
export const metadata = pageMetadata({
  ...
  title: 'Contact us',
  description:
    'Contact The Hillside Gardens about plants, products, orders or custom arrangements.'
});
    ...
    <>
      <section className="pagehero">
        <div className="container">
          ...
          <h1>Contact us.</h1>
          <p>Questions about a plant, an order or a custom planter? Send a note directly to The Hillside Gardens.</p>
        </div>
      </section>
        ...
        <div className="container contact-grid">
          <div>
            ...
            <div className="info-list">
              ...
              <div className="info-item"><MapPin size={20} /><b>Local pickup</b><span>Exact pickup details are shared directly with confirmed customers.</span></div>
            </div>
          </div>
          <ContactForm />
        </div>
