...
export async function saveCareGuide(formData: FormData) {
  ...
  const data = {
    ...
    light: text(formData, 'light') || null,
    water: text(formData, 'water') || null,
    humidity: text(formData, 'humidity') || null,
    soil: text(formData, 'soil') || null,
    feeding: text(formData, 'feeding') || null,
    temperature: text(formData, 'temperature') || null,
